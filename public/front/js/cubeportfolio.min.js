!(function (e, t, n, o) {
  ...
  e.extend(i.prototype, {
    ...
    wrapInner: function (e, t) {
      ...
      if (((t = t || ""), !(e.length && e.length < 1)))
        for (e.length === o && (e = [e]), a = e.length - 1; a >= 0; a--) {
          for (
            i = e[a], (r = n.createElement("div")).setAttribute("class", t);
            i.childNodes.length;
            ...
            if (n.hasAttribute("width") && n.hasAttribute("height")) {
              ...
              if (null === o.checkSrc(n)) o.removeAttrImage(n);
                ...
                i.on("load.cbp error.cbp", function () {
                  ...
                  n.srcset
                    ? (i.attr("sizes", n.sizes || "100vw"),
                      i.attr("srcset", n.srcset))
                    : i.attr("src", n.src);
              }
              return null;
            }
        ...
        0 !== a
          ? e.each(i, function (t, i) {
              ...
              r.on("load.cbp error.cbp", function () {
                ...
                i.srcset
                  ? (r.attr("sizes", i.sizes), r.attr("srcset", i.srcset))
                  : r.attr("src", i.src);
            })
          : n.call(o);
      });
    ...
    checkSrc: function (t) {
      ...
      var a = e("<img>");
      n
        ? (a.attr("sizes", t.sizes || "100vw"), a.attr("srcset", n))
        : a.attr("src", i);
      var r = a[0];
      return r.complete && r.naturalWidth !== o && 0 !== r.naturalWidth
        ? null
        : r;
    },
    display: function () {
      ...
      "responsive" === t.options.gridAdjustment
        ...
        : (t.blocks.removeAttr("style"),
          t.blocks.each(function (n, o) {
            ...
            (i.height = s),
              (i.heightAndGap = s + t.options.gapHorizontal),
              (i.width = r),
              (i.widthAndGap = r + t.options.gapVertical);
          }),
    ...
    responsiveLayout: function () {
      ...
      (t.cols =
        t[
          e.isArray(t.options.mediaQueries)
            ? "getColumnsBreakpoints"
            : "getColumnsAuto"
        ]()),
        (t.columnWidth = t.columnWidthTruncate(
          (t.width + t.options.gapVertical) / t.cols
        )),
        ...
        t.blocks.each(function (n, o) {
          var i,
            a = e(o).data("cbp"),
            r = 1;
          "mosaic" === t.options.layoutMode &&
            (r = t.getColsMosaic(a.widthInitial)),
    ...
    getColsMosaic: function (e) {
      ...
      return (
        (n = n % 1 >= 0.79 ? Math.ceil(n) : Math.floor(n)),
        Math.min(Math.max(n, 1), t.cols)
      );
    },
    ...
    registerEvent: function (e, t, n) {
      var o = this;
      o.registeredEvents[e] || (o.registeredEvents[e] = []),
        o.registeredEvents[e].push({ func: t, oneTime: n || !1 });
    },
    triggerEvent: function (e, t) {
      ...
      if (i.registeredEvents[e])
        for (n = 0, o = i.registeredEvents[e].length; n < o; n++)
          i.registeredEvents[e][n].func.call(i, t),
            i.registeredEvents[e][n].oneTime &&
              (i.registeredEvents[e].splice(n, 1), n--, o--);
    },
    addItems: function (t, n, o) {
      var a = this;
      a.wrapInner(t, "cbp-item-wrapper"),
        a.$ul[o](t.addClass("cbp-item-loading").css({ top: "100%", left: 0 })),
        i["private"].modernBrowser
        ...
        a.loadImages(t, function () {
          if ((a.$obj.addClass("cbp-updateItems"), "append" === o))
            a.storeData(t, a.blocks.length), e.merge(a.blocks, t);
          else {
            a.storeData(t);
            var n = t.length;
          ...
          a.triggerEvent("addItemsToDOM", t),
    ...
    addItemsFinish: function (t, n) {
      var o = this;
      (o.isAnimating = !1),
        o.$obj.removeClass("cbp-updateItems"),
        t.removeClass("cbp-item-loading"),
        e.isFunction(n) && n.call(o, t),
        o.$obj.trigger("onAfterLoadMore.cbp", [t]);
    },
    ...
    (e.fn.cubeportfolio = function (e, t, n) {
      return this.each(function () {
        if ("object" == typeof e || !e)
          return i["public"].init.call(this, e, t);
    ...
    e.extend(i.prototype, {
      mosaicLayoutReset: function () {
        ...
        (t.blocksAreSorted = !1),
          t.blocksOn.each(function (n, o) {
            (e(o).data("cbp").pack = !1),
              t.options.sortByDimension && (o.style.height = "");
          }),
          (t.freeSpaces = [
            {
              leftStart: 0,
      ...
      mosaicLayout: function () {
        for (var e = this, t = 0, n = e.blocksOn.length; t < n; t++) {
          ...
          e.generateF1F2(o.spaceIndex, o.dataBlock),
            e.generateG1G2G3G4(o.dataBlock),
            e.cleanFreeSpaces(),
            e.addHeightToBlocks();
        }
              ...
              t.blocksOn.each(function (t, s) {
                ...
                if (!0 !== l.pack)
                  return l.widthAndGap <= a && l.heightAndGap <= r
                    ? ((l.pack = !0),
                      (n = { spaceIndex: o, dataBlock: l }),
                      (l.leftNew = i.leftStart),
                      (l.topNew = i.topStart),
                      !1)
                    : void 0;
              }),
              !t.blocksAreSorted && t.options.sortByDimension && o > 0
                ? ((n = null), !1)
                : null === n && void 0
            );
          }),
      ...
      generateF1F2: function (e, t) {
        ...
        n.freeSpaces.splice(e, 1),
          i.leftEnd > i.leftStart &&
            i.topEnd > i.topStart &&
            (n.freeSpaces.splice(e, 0, i), e++),
          a.leftEnd > a.leftStart &&
            a.topEnd > a.topStart &&
            n.freeSpaces.splice(e, 0, a);
      },
      ...
      intersectSpaces: function (e, t) {
        ...
        return i <= o || r <= a
          ? null
          : { leftStart: o, leftEnd: i, topStart: a, topEnd: r };
      },
      ...
      correctSubPixelValues: function () {
        var e,
          ...
          o,
          i = this;
        for (e = 0, t = i.freeSpaces.length - 1; e < t; e++)
          (n = i.freeSpaces[e]),
            (o = i.freeSpaces[e + 1]).topStart - n.topStart <= 1 &&
              (o.topStart = n.topStart);
      },
          ...
          (t.freeSpaces = e.map(t.freeSpaces, function (n, o) {
            return (
              e.each(t.freeSpaces, function (e, t) {
                if (o !== e)
                  return t.leftStart <= n.leftStart &&
                    t.leftEnd >= n.leftEnd &&
      ...
      uniqueFreeSpaces: function () {
        ...
        e.each(t.freeSpaces, function (t, o) {
          e.each(n, function (e, t) {
            if (
              t.leftStart === o.leftStart &&
              t.leftEnd === o.leftEnd &&
              t.topStart === o.topStart &&
              t.topEnd === o.topEnd
            )
              return (o = null), !1;
          }),
      ...
      addHeightToBlocks: function () {
        ...
        e.each(t.freeSpaces, function (n, o) {
          t.blocksOn.each(function (n, i) {
            var a = e(i).data("cbp");
            !0 === a.pack &&
              t.intersectSpaces(o, a) &&
              -1 === o.topStart - a.topNew - a.heightAndGap &&
              (i.style.height = a.height - 1 + "px");
          });
        });
      },
      sortBlocks: function (t, n, o, i) {
        (o = void 0 === o ? "leftNew" : o),
          (i = void 0 === i ? 1 : -1),
          t.sort(function (t, a) {
            var r = e(t).data("cbp"),
              s = e(a).data("cbp");
    ...
    i["public"] = {
      ...
      filter: function (t, n) {
        ...
        if (!a.isAnimating) {
          if (
            ((a.isAnimating = !0),
            e.isFunction(n) && a.registerEvent("filterFinish", n, !0),
            e.isFunction(t))
          ) {
            if (void 0 === (o = t.call(a, a.blocks)))
              throw new Error(
            ...
            if (a.options.filterDeeplinking) {
              ...
              (location.href = r + "#cbpf=" + encodeURIComponent(t)),
                a.singlePage &&
                  a.singlePage.url &&
    ...
    e.extend(i.prototype, {
      updateSliderPagination: function () {
        ...
        if (o.options.showPagination) {
          for (
            t = Math.ceil(o.blocksOn.length / o.cols),
              o.navPagination.empty(),
              n = t - 1;
            n >= 0;
            n--
          )
      ...
      nextSlider: function (e) {
        ...
        if (t.isEndSlider()) {
          ...
          t.options.scrollByPage
            ? (t.sliderActive = Math.min(
                t.sliderActive + t.cols,
                t.blocksOn.length - t.cols
              ))
            : (t.sliderActive += 1);
        t.goToSlider();
      },
      ...
      jumpDragToSlider: function (e) {
        var t,
          ...
          i = this,
          a = e > 0;
        i.options.scrollByPage
          ? ((t = i.cols * i.columnWidth), (n = i.cols))
          : ((t = i.columnWidth), (n = 1)),
          (e = Math.abs(e)),
          (o = Math.floor(e / t) * n),
          e % t > 20 && (o += n),
          (i.sliderActive = a
            ? Math.min(i.sliderActive + o, i.blocksOn.length - i.cols)
            : Math.max(0, i.sliderActive - o)),
          i.goToSlider();
      },
      ...
      enableDisableNavSlider: function () {
        var e,
          ...
          n = this;
        n.isRewindNav() ||
          ((t = n.isStartSlider() ? "addClass" : "removeClass"),
          n.navPrev[t]("cbp-nav-stop"),
          (t = n.isEndSlider() ? "addClass" : "removeClass"),
          n.navNext[t]("cbp-nav-stop")),
          n.options.showPagination &&
            ((e = n.options.scrollByPage
      ...
      isRewindNav: function () {
        ...
        return (
          ...
          (!(e.blocksOn.length <= e.cols) && !!e.options.rewindNav)
        );
      },
      ...
      sliderLayout: function () {
        ...
        t.blocksOn.each(function (n, o) {
          var i = e(o).data("cbp");
          (i.leftNew = t.columnWidth * n),
            (i.topNew = 0),
            t.sliderFreeSpaces.push({ topStart: i.heightAndGap });
        }),
          t.getFreeSpacesForSlider(),
          t.$ul.width(
            t.columnWidth * t.blocksOn.length - t.options.gapVertical
          );
      },
      getFreeSpacesForSlider: function () {
        var e = this;
        (e.freeSpaces = e.sliderFreeSpaces.slice(
          e.sliderActive,
      ...
      updateSliderPosition: function () {
        ...
        i["private"].modernBrowser
          ? (e.$ul[0].style[i["private"].transform] =
      ...
      dragSlider: function () {
          ...
          b.$obj.removeClass("cbp-mode-slider-dragStart"),
            ...
            0 !== u
              ? (d.one("click.cbp", function (e) {
                ...
                requestAnimationFrame(function () {
                  b.jumpDragToSlider(u),
                    b.$ul.one(i["private"].transitionend, l);
                }))
              : l.call(b),
            v.off(y.move),
            v.off(y.end);
        ...
        function s(e) {
          ((u = c - p(e).x) > 8 || u < -8) && e.preventDefault(),
            (b.isDrag = !0);
          var t = f - u;
          u < 0 && u < f
            ? (t = (f - u) / 5)
            : u > 0 && f - u < -g && (t = (g + f - u) / 5 - g),
            i["private"].modernBrowser
              ? (b.$ul[0].style[i["private"].transform] =
                  "translate3d(" + t + "px, 0px, 0)")
              : (b.$ul[0].style.left = t + "px");
        }
        function l() {
    ...
    (i.prototype.filterLayout = function () {
      ...
      n.$obj.addClass("cbp-animation-" + n.options.animationType),
        ...
        n.blocksOn2Off.length
          ? n.blocksOn2Off
              .last()
              .data("cbp")
              .wrapper.one(a["private"].animationend, t)
      ...
      (a.plugins.animationClassic = function (t) {
        return !a["private"].modernBrowser ||
          e.inArray(t.options.animationType, [
            "boxShadow",
            "fadeOut",
            "flipBottom",
            "flipOut",
          ...
          n.$obj.addClass("cbp-animation-" + n.options.animationType),
            ...
            n.blocksOn.removeClass("cbp-item-off").each(function (t, o) {
              ...
              (i.left = i.leftNew),
                ...
                "sequentially" === n.options.animationType &&
                  (i.wrapper[0].style[a["private"].animationDelay] =
                    60 * t + "ms");
            }),
            n.blocksOn.length
              ? n.blocksOn
  ...
  (function (e, t, n, o) {
    ...
    (i.prototype.filterLayout = function () {
      ...
      var n = this,
        o = n.$ul.clone(!0, !0);
      o[0].setAttribute("class", "cbp-wrapper-helper"),
        n.wrapper[0].insertBefore(o[0], n.$ul[0]);
          ...
          n.$obj.addClass("cbp-animation-" + n.options.animationType),
            ...
            n.blocksOn.removeClass("cbp-item-off").each(function (t, n) {
              ...
              (o.left = o.leftNew),
                ...
                (n.style.left = o.left + "px"),
                (n.style.top = o.top + "px"),
                (o.wrapper[0].style[a["private"].animationDelay] =
                  50 * t + "ms");
            });
      ...
      o.setAttribute("class", "cbp-wrapper-helper"),
        ...
        requestAnimationFrame(function () {
          n.$obj.addClass("cbp-animation-" + n.options.animationType),
            ...
            n.blocksOn.length
              ? n.$ul.one(a["private"].animationend, t)
              : n.blocksOnInitial.length
              ? e(o).one(a["private"].animationend, t)
              : t(),
            n.resizeMainContainer();
        });
    }),
    ...
    function i(e) {
      ...
      (t.parent = e),
        ...
        e.registerEvent("onMediaQueries", function (e) {
          e && e.hasOwnProperty("caption")
            ? t.captionOn !== e.caption &&
              (t.destroy(), (t.captionOn = e.caption), t.init())
            : t.captionOn !== n.caption &&
              (t.destroy(), (t.captionOn = n.caption), t.init());
        }),
        t.init();
    }
    var a = e.fn.cubeportfolio.constructor;
    (i.prototype.init = function () {
      ...
      "" != e.captionOn &&
        ("expand" === e.captionOn ||
          ...
          (e.parent.options.caption = e.captionOn = "minimal"),
        e.parent.$obj.addClass(
          "cbp-caption-active cbp-caption-" + e.captionOn
        ));
    }),
      (i.prototype.destroy = function () {
          ...
          function () {
            t.$obj.on("click.cbp", ".cbp-caption-defaultWrap", function (n) {
              if ((n.preventDefault(), !t.isAnimating)) {
                ...
                if (
                  (t.$obj.addClass("cbp-caption-expand-active"),
          ...
          if (!(t.width <= 0)) {
            ...
            t.pushQueue("delayFrame", n),
              t.blocksOn.each(function (e, n) {
                n.style[a["private"].animationDelay] =
                  e * t.options.displayTypeSpeed + "ms";
              }),
      ...
      t.registerEvent(
        ...
        function () {
          if (!(t.width <= 0)) {
            var n = e.Deferred();
            t.pushQueue("delayFrame", n),
              (t.obj.style[a["private"].animationDuration] =
                t.options.displayTypeSpeed + "ms"),
    ...
    (i.prototype.registerFilter = function () {
          ...
          r.hasClass("cbp-l-filters-dropdown") &&
            ...
            l.on("click.cbp", function () {
              ...
              if (!o.hasClass("active") && !n.isAnimating) {
                t.filtersCallback(p, o),
                  e.data(a, "filterName", o.data("filter"));
      ...
      (i.prototype.filtersCallback = function (t, n) {
        e.isEmptyObject(t) ||
          ...
          t.headerText ? (t.headerText = "") : t.header.html(n.html())),
          n.addClass("active").siblings().removeClass("active");
      }),
    ...
    function i(t) {
      ...
      t.registerEvent("onMediaQueries", function (i) {
        (t.options.gapVertical =
          i && i.hasOwnProperty("gapVertical") ? i.gapVertical : n),
          (t.options.gapHorizontal =
            i && i.hasOwnProperty("gapHorizontal") ? i.gapHorizontal : o),
          t.blocks.each(function (n, o) {
            var i = e(o).data("cbp");
            (i.widthAndGap = i.width + t.options.gapVertical),
              (i.heightAndGap = i.height + t.options.gapHorizontal);
          });
      });
    }
    e.fn.cubeportfolio.constructor.plugins.changeGapOnMediaQueries = function (
      e
    ) {
      return new i(e);
    };
    ...
    function a(e) {
      ...
      e.hasClass("cbp-slider-inline-ready") ||
        ...
        e.find(".cbp-slider-next").on("click.cbp", function (e) {
          e.preventDefault(),
            t.active < t.total
              ? (t.active++, t.updateLeft())
              : t.active === t.total && ((t.active = 0), t.updateLeft());
        }),
        e.find(".cbp-slider-prev").on("click.cbp", function (e) {
          e.preventDefault(),
            t.active > 0
              ? (t.active--, t.updateLeft())
              : 0 === t.active && ((t.active = t.total), t.updateLeft());
        }));
    }
    var r = {},
  ...
  (function (e, t, n, o) {
    ...
    var a = { loadingClass: "cbp-lazyload", threshold: 400 },
      ...
      s = e(t);
    (r["private"].lazyLoadScroll = new r["private"].publicEvents(
      "scroll.cbplazyLoad",
      50
    )),
          ...
          n.each(function (n, o) {
            ...
            if (t.isElementInScreen(o)) {
              ...
              null === t.parent.checkSrc(e("<img>").attr("src", a))
                ? (t.removeLazyLoad(o, a),
                  i.removeClass(t.options.loadingClass))
    ...
    (i.prototype.populateItems = function () {
      ...
      (i.prototype.populateInsertItems = function (t) {
        ...
        n.items.each(function (t, r) {
          ...
          i && "*" !== i
            ? e(r).filter(i).length && (o.push(r), (n.items[t] = null), a++)
            : (o.push(r), (n.items[t] = null), a++);
        }),
          (n.items = n.items.map(function (e, t) {
            return t;
          })),
          0 !== o.length
            ? n.parent.$obj.cubeportfolio("append", o, t)
            : n.loadMore
      ...
      (i.prototype.auto = function () {
        ...
        function o() {
          ...
          0 === (e = t && "*" !== t ? i.items.filter(t).length : i.items.length)
            ? i.loadMore
                .removeClass("cbp-l-loadMore-loading")
                .addClass("cbp-l-loadMore-stop")
            : (i.loadItems.html(e), a.trigger("scroll.loadMore")),
            (s = !1),
            0 === i.items.length &&
              (r["private"].loadMoreScroll.destroyEvent(i),
              i.parent.$obj.off("filterComplete.cbp"));
        }
        var i = this,
          a = e(t),
          s = !1;
      ...
      (i.prototype.destroy = function () {
        this.loadMore.off(".cbp"),
          r["private"].loadMoreScroll &&
            r["private"].loadMoreScroll.destroyEvent(this);
      }),
      (r.plugins.loadMore = function (e) {
        ...
        return (
          ...
          e.options.loadMoreAction &&
            (t.loadMore || (t.loadMore = {}),
            (t.loadMore.action = e.options.loadMoreAction)),
          t.loadMore &&
            void 0 !== t.loadMore.selector &&
            ((t.loadMore.element = t.loadMore.selector),
  ...
  (function (e, t, n, o) {
    ...
    function i(e) {
      var t = this;
      (t.parent = e),
        !1 === e.options.lightboxShowCounter &&
          (e.options.lightboxCounter = ""),
        !1 === e.options.singlePageShowCounter &&
      ...
      s = {
                  ...
                  (e.each(s, function (t, n) {
                    if (
                      (a.cubeportfolio.blocksOn.each(function (t, o) {
                        var r = e(o).find(
                          a.options.singlePageDelegate + '[href="' + n + '"]'
                        );
            ...
            if (
              ...
              e.each(s, function (t, n) {
                if (
                  (a.cubeportfolio.blocksOn.each(function (t, o) {
                    var r = e(o).find(
                      a.options.singlePageInlineDelegate + '[href="' + n + '"]'
                    );
                    if (r.length) return (i = r), !1;
                  }),
                  i)
        ...
        createMarkup: function () {
          ...
          "singlePage" === t.type &&
            ...
            (o = " cbp-popup-singlePage-" + t.options.singlePageAnimation),
            (t.wrap = e("<div/>", {
            ...
            "ie8" === a["private"].browser &&
              (t.bg = e("<div/>", {
                class: "cbp-popup-ie8bg",
                "data-action": "lightbox" === t.type ? "close" : "",
              }).appendTo(t.wrap)),
            "singlePage" === t.type &&
            !1 === t.options.singlePageStickyNavigation
            ...
            "singlePage" === t.type &&
              (t.options.singlePageCounter &&
                ((t.counter = e(t.options.singlePageCounter).appendTo(
                  t.navigation
                )),
                t.counter.text("")),
              t.content.on(
        ...
        createMarkupSinglePageInline: function () {
          var t = this;
          (t.wrap = e("<div/>", { class: "cbp-popup-singlePageInline" }).on(
            "click.cbp",
            function (n) {
              if (!t.stopEvents) {
                var o = e(n.target).attr("data-action");
            ...
            (t.content = e("<div/>", { class: "cbp-popup-content" }).appendTo(
              t.wrap
            )),
            (t.navigation = e("<div/>", {
              class: "cbp-popup-navigation",
            ...
            e.each(o, function (t, n) {
              ...
              if (-1 === e.inArray(i, c)) {
                ...
                if (/youtu\.?be/i.test(i)) {
                  ...
                  1 === u && (u = i.lastIndexOf("/") + 1),
                    (o = i.substring(u)),
                    /autoplay=/i.test(o) || (o += "&autoplay=1"),
                    (r =
                  ...
                  /vimeo\.com/i.test(i)
                    ...
                    ? ((r =
                        -1 !== i.indexOf("|") ? i.split("|") : i.split("%7C")),
                      (l = "isSelfHostedVideo"))
          ...
          if (!s.isOpen) {
            ...
            if (
              (e.each(o, function (t, n) {
                ...
                -1 === e.inArray(o, p) &&
                  (r === o && (s.current = l),
                  s.dataArray.push({ url: o, element: n }),
                  l++),
                  p.push(o);
              }),
              (s.counterTotal = s.dataArray.length),
              ...
              e.isFunction(s.options.singlePageCallback) &&
        ...
        openSinglePageInline: function (n, o, i) {
          ...
          if (
            ...
            (l.fromOpen = i),
            (l.storeBlocks = n),
            (l.storeCurrentBlock = o),
            l.isOpen)
          )
            return (
              (r = l.cubeportfolio.blocksOn.index(e(o).closest(".cbp-item"))),
              void (l.dataArray[l.current].url !== o.getAttribute("href") ||
              l.current !== r
          ...
          if (
            ...
            (l.blocksToMove = e()), (l.top = l.cubeportfolio.height);
            ...
            (l.top = u),
              ...
              n.each(function (t, n) {
                var o = e(n),
                  ...
                  a = i + o.height();
                a <= u ||
                  (i >= u && (l.blocksToMove = l.blocksToMove.add(n)),
                  i < u &&
                    a > u &&
          ...
          l.cubeportfolio.$obj.addClass("cbp-popup-singlePageInline-open"),
            ...
            e.isFunction(l.options.singlePageInlineCallback) &&
                ...
                r.readyState
                  ? (r.onreadystatechange = function () {
                      ("loaded" != r.readyState &&
                        ...
                        ((r.onreadystatechange = null), e[++o] && i(e[o]));
                    })
                  : (r.onload = function () {
                      e[++o] && i(e[o]);
                    }),
        ...
        updateSinglePageIsOpen: function () {
          ...
          t.wrap.addClass("cbp-popup-ready"),
            ...
            (e = t.content.find(".cbp-slider")).length
              ? (e.find(".cbp-slider-item").addClass("cbp-item"),
        ...
        updateSelfHostedVideo: function (e, t, n) {
          ...
          for (o = 0; o < e.length; o++)
            /(\.mp4)/i.test(e[o])
              ...
              : /(\.webm)/i.test(e[o]) &&
                (a += '<source src="' + e[o] + '" type="video/webm">');
          (a +=
        ...
        lightboxJumpTo: function (e) {
          ...
          (n.current = n.getIndex(n.current + e)),
            n[(t = n.dataArray[n.current]).type](t);
        },
        singlePageJumpTo: function (t) {
          ...
          (n.current = n.getIndex(n.current + t)),
            e.isFunction(n.options.singlePageCallback) &&
              ...
              n.slider &&
                a["private"].resize.destroyEvent(
                  e.data(n.slider[0], "cubeportfolio")
                ),
        ...
        resetWrap: function () {
          ...
          "singlePage" === e.type &&
            ...
            (location.href = e.url + "#"),
            "singlePageInline" === e.type &&
              e.options.singlePageInlineDeeplinking &&
              (location.href = e.url + "#");
        },
        getIndex: function (e) {
          var t = this;
        ...
        close: function (n, o) {
          function i() {
            s.slider &&
              a["private"].resize.destroyEvent(
                e.data(s.slider[0], "cubeportfolio")
              ),
              s.content.html(""),
              s.wrap.detach(),
              s.cubeportfolio.$obj.removeClass(
                "cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close"
              ),
              "promise" === n &&
                e.isFunction(o.callback) &&
                o.callback.call(s.cubeportfolio);
          }
          function r() {
            var o = e(t).scrollTop();
            s.resetWrap(),
            ...
            "singlePageInline" === s.type
              ? "open" === n
                ? (s.wrap.removeClass("cbp-popup-singlePageInline-ready"),
                  e(s.dataArray[s.current].element)
                    .closest(".cbp-item")
                    .removeClass("cbp-singlePageInline-active"),
              ...
              ? (s.resetWrap(),
                ...
                e("html").css({ overflow: "", marginRight: "", position: "" }),
                ("ie8" !== a["private"].browser &&
                  "ie9" !== a["private"].browser) ||
                  (s.slider &&
                    a["private"].resize.destroyEvent(
              ...
              : ((l = !1),
                s.originalStyle
                  ? e("html").attr("style", s.originalStyle)
                  : e("html").css({ overflow: "", marginRight: "" }),
                e(t).scrollTop(s.scrollTop),
                s.slider &&
                  a["private"].resize.destroyEvent(
                    e.data(s.slider[0], "cubeportfolio")
        ...
        preloadNearbyImages: function () {
          for (
            ...
            "isImage" === e.dataArray[t[n]].type &&
              e.cubeportfolio.checkSrc(e.dataArray[t[n]]);
        },
      },
      l = !1,
      p = !1,
              ...
              ? s.blocksOn.each(function (t, n) {
                  ...
                  i.not(".cbp-item-off") &&
                    i.find(o.options.lightboxDelegate).each(function (t, n) {
                      a
                        ? e(n).attr("data-cbp-lightbox") === a && l.push(n)
                        : l.push(n);
                    });
                })
              : (l = a
                  ...
                  : r.find(o.options.lightboxDelegate)),
              ...
              ? s.blocksOn.each(function (t, n) {
                  ...
                  i.not(".cbp-item-off") &&
                    i.find(o.options.singlePageDelegate).each(function (t, n) {
                      a
                        ? e(n).attr("data-cbp-singlePage") === a && l.push(n)
                        : l.push(n);
                    });
                })
              : (l = a
                  ...
                  : r.find(o.options.singlePageDelegate)),
        ...
        o.options.singlePageInlineDelegate &&
          ...
          o.$obj.on(
            ...
            function (t) {
              ...
              (!n || i - n > 300) &&
                o.singlePageInline.openSinglePageInline(o.blocksOn, this);
            }
          ));
    }),
  ...
  (function (e, t, n, o) {
    ...
    function i(t) {
      var n = this;
      (n.parent = t),
        (n.options = e.extend({}, a, n.parent.options.plugins.slider));
      ...
      o.length > 0 &&
        ...
        n.parent.customPaginationItems.on("click.cbp", function (t) {
          t.preventDefault(),
            ...
            t.stopPropagation(),
            n.parent.sliderStopEvents || n.parent.jumpToSlider(e(this));
        })),
        n.parent.registerEvent(
          "gridAdjust",
          function () {
    ...
    (i.prototype.sliderMarkup = function () {
      ...
      (i.prototype.destroy = function () {
        var e = this;
        e.parent.customPaginationItems &&
          e.parent.customPaginationItems.off(".cbp"),
          (e.parent.controls || e.parent.navPagination) &&
            (e.parent.nav.off(".cbp"), e.parent.nav.remove());
      }),
  ...
  (function (e, t, n, o) {
      ...
      (n.parent = t),
        ...
        0 !== n.element.length &&
          ...
          n.element.on("click.cbp", ".cbp-sort-item", function (o) {
            o.preventDefault(),
              (n.target = o.target),
              e(n.target).hasClass("cbp-l-dropdown-item--active") ||
                t.isAnimating ||
                (n.processSort(),
    ...
    (i.prototype.processSort = function () {
      ...
      if (o && i)
        (t.sort = c.getAttribute("data-sort")),
      ...
      if (
        ...
        n.blocks.each(function (n, o) {
          ...
          "int" === r && (a = parseInt(a, 10)),
            ...
            l.push({ sortText: a, data: i.data("cbp") });
        }),
          l.sort(function (e, t) {
            var n = e.sortText,
              o = t.sortText;
            return (
              "string" === r && ((n = n.toUpperCase()), (o = o.toUpperCase())),
              n < o ? -s : n > o ? s : 0
            );
          }),

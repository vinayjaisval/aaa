                        ...
                        @foreach ($Topics as $Topic)
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="blog-head bg-white p-2">
                                    <a href="{{$topic_link_url}}"> <img src="{{ URL::to('public/uploads/topics/'.$Topic->photo_file) }}" alt="Blog Image"></a>
                                        <div class="event-details">
                                            <a href="{{$topic_link_url}}"> <h3 class="py-2 px-2 text-center">{{ $title }}</h3></a>
                                        </div>
                                    {{-- <div class="plus-title text-center">
                                        <a href="{{url('blog/').'/'.$Topic->slug}}">
                                            <button class="bg-white border-0 px-4 py-2 rounded df">Voir Plus</button>
                                        </a>
                                    </div> --}}
                                </div>
                            </div>

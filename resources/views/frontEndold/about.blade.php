...
@section('content')
    <div class="home-page">
        ...
        @include('frontEnd.aboutpages.about')
        @include('frontEnd.aboutpages.fromtheceo')
        @include('frontEnd.aboutpages.companyhistory')
        @include('frontEnd.aboutpages.whyjoinus')
        @include('frontEnd.aboutpages.ourbussiness')
        @include('frontEnd.aboutpages.officelocation')

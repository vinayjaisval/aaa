                                    ...
                                    <td class="h6 nowrap">
                                        @if($Section->photo !="")
                                            <div class="pull-right">
                                                <img src="{{ asset('public/uploads/sections/'.$Section->photo) }}"
                                ...
                                @foreach($Section->fatherSections as $subSection)
                                    ...
                                    <tr>
                                        ...
                                        <td class="h6 nowrap">
                                            @if($subSection->photo !="")
                                                <div class="pull-right">
                                                    <img src="{{ asset('public/uploads/sections/'.$subSection->photo) }}"
                                                         style="height: 30px" alt="{{ $title }}">
                                                </div>
                                            @endif
                                            <img
                                                src="{{ asset('public/assets/dashboard/images/treepart_'.@Helper::currentLanguage()->direction.'.png') }}"
                                                class="submenu_tree">
                                        ...
                                        <tr>
                                            ...
                                            <td class="h6 nowrap">
                                                @if($subSection2->photo !="")
                                                    <div class="pull-right">
                                                        <img src="{{ asset('public/uploads/sections/'.$subSection2->photo) }}"
                                                             style="height: 30px" alt="{{ $title }}">
                                                    </div>
                                                @endif
                                                <img
                                                    src="{{ asset('public/assets/dashboard/images/treepart_sub_'.@Helper::currentLanguage()->direction.'.png') }}"
                                                    class="submenu_tree">

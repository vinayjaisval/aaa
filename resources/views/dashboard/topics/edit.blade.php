                                        ...
                                        @if($Topic->video_type==0 && $Topic->video_file!="")
                                            <div class="box p-a-xs">
                                                ...
                                                <video width="380" height="230" controls>
                                                    <source src="{{ asset('public/uploads/topics/'.$Topic->video_file) }}"
                                                            type="video/mp4">
                                                    Your browser does not support the video tag.
                                                </video>
                                                <br>
                                                <a target="_blank"
                                                   href="{{ asset('public/uploads/topics/'.$Topic->video_file) }}">
                                                    {{ $Topic->video_file }} </a>
                                            </div>
                                        @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Topic->audio_file!="")
                                        <div class="box p-a-xs">
                                            <audio controls>
                                                <source src="{{ asset('public/uploads/topics/'.$Topic->audio_file) }}"
                                                        type="audio/mpeg">
                                                Your browser does not support the audio element.
                                            </audio>
                                            <br>
                                            <a target="_blank"
                                               href="{{ asset('public/uploads/topics/'.$Topic->audio_file) }}"> {{ $Topic->audio_file }} </a>
                                        </div>
                                    @endif
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div id="topic_photo" class="col-sm-4 box p-a-xs">
                                                    <a target="_blank"
                                                       href="{{ asset('public/uploads/topics/'.$Topic->photo_file) }}"><img
                                                            src="{{ asset('public/uploads/topics/'.$Topic->photo_file) }}"
                                ...
                                <div class="col-sm-10">
                                    @if($Topic->attach_file!="")
                                        <div id="topic_attach" class="col-sm-4 box p-a-xs">
                                            <a target="_blank"
                                               href="{{ asset('public/uploads/topics/'.$Topic->attach_file) }}"> {{ $Topic->attach_file }} </a>
                                            <br>
                                            ...
                                            <div class="col-sm-10">
                                                @if($cf_saved_val !="")
                                                    ...
                                                    <div id="{{$file_name_id}}" class="col-sm-4 box p-a-xs">
                                                        <video width="380" height="230" controls>
                                                            <source src="{{ asset('public/uploads/topics/'.$cf_saved_val) }}"
                                                                    type="video/mp4">
                                                            Your browser does not support the video tag.
                                                        </video>
                                                        <a target="_blank"
                                                           href="{{ asset('public/uploads/topics/'.$cf_saved_val) }}">
                                                            {{ $cf_saved_val }}
                                                        </a>
                                                        <br>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                @if($cf_saved_val !="")
                                                    ...
                                                    <div id="{{$file_name_id}}" class="col-sm-4 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ asset('public/uploads/topics/'.$cf_saved_val) }}"><img
                                                                src="{{ asset('public/uploads/topics/'.$cf_saved_val) }}"
                                                                class="img-responsive">
                                                            {{ $cf_saved_val }}
                                                        </a>
                                                        <br>
...
@push("after-scripts")
    ...
    <script>
        ...
        $("#topic_delete_btn").click(function () {
            $(this).html("<img src=\"{{ asset('public/assets/dashboard/images/loading.gif') }}\" style=\"height: 25px\"/> {!! __('backend.yes') !!}");

@if($WebmasterSection->multi_images_status)
    <div class="tab-pane  {{ $tab_3 }}" id="tab_photos">
        ...
        <div class="box-body">
            ...
            <div>
                {{Form::open(['route'=>['topicsPhotosEdit',"webmasterId"=>$WebmasterSection->id,"id"=>$Topic->id],'method'=>'POST','class'=>'dropzone white', 'files' => true])}}
            ...
            @if(count($Topic->photos)>0)
                <div class="row">
                    {{Form::open(['route'=>['topicsPhotosUpdateAll',$WebmasterSection->id,$Topic->id],'method'=>'post'])}}
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3">
                            <div class="box p-a-xs">
                                ...
                                <div class="text-center">
                                    <img src="{{ asset('public/uploads/topics/'.$photo->file) }}"
                                ...
                                <div class="p-a-sm">
                                    <div class="text-ellipsis">
                                        ...
                                        <a style="display: block;overflow: hidden;"
                                           href="{{ asset('public/uploads/topics/'.$photo->file) }}"
                                           target="_blank">
